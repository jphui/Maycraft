...
{ private Cat cat;
  ...
  private Coin coin;
    ...
    public Area2()
    {
        ...
        randomlyGenerateArea(2);
        render();
        cat = new Cat();
        setBackground("img/nether.jpg");
    ...
    {
        int edwin = (int)(Math.random()*100); //1 out of 150 chance to spawn during each iteration of the game loop
